...
public class ConfigEntryBuilderImpl implements ConfigEntryBuilder {
    ...
    private Text resetButtonKey = Text.translatable("text.cloth-config.reset_value");
    ...
    public TextDescriptionBuilder startTextDescription(Text value) {
        return new TextDescriptionBuilder(resetButtonKey, Text.literal(UUID.randomUUID().toString()), value);
    }
