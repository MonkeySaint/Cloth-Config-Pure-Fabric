...
public abstract class AbstractSliderFieldBuilder<T, A extends AbstractConfigListEntry, SELF extends FieldBuilder<T, A, SELF>> extends AbstractRangeFieldBuilder<T, A, SELF> {
    protected Function<T, Text> textGetter = null;
    
    protected AbstractSliderFieldBuilder(Text resetButtonKey, Text fieldNameKey) {
        super(resetButtonKey, fieldNameKey);
    }
    
    public SELF setTextGetter(Function<T, Text> textGetter) {
