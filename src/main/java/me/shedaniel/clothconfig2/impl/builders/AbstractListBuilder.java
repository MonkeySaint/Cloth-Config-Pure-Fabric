...
public abstract class AbstractListBuilder<T, A extends AbstractConfigListEntry, SELF extends AbstractListBuilder<T, A, SELF>> extends AbstractFieldBuilder<List<T>, A, SELF> {
    ...
    private Text addTooltip = Text.translatable("text.cloth-config.list.add");
    private Text removeTooltip = Text.translatable("text.cloth-config.list.remove");
    private boolean insertButtonEnabled = true, deleteButtonEnabled = true, insertInFront = false;
    
    protected AbstractListBuilder(Text resetButtonKey, Text fieldNameKey) {
    ...
    public SELF setCellErrorSupplier(Function<T, Optional<Text>> cellErrorSupplier) {
    ...
    public SELF setAddButtonTooltip(Text addTooltip) {
        this.addTooltip = addTooltip;
        return (SELF) this;
    }
    
    public SELF setRemoveButtonTooltip(Text removeTooltip) {
