...
public class KeyCodeBuilder extends FieldBuilder<ModifierKeyCode, KeyCodeEntry, KeyCodeBuilder> {
    ...
    public KeyCodeBuilder setKeySaveConsumer(Consumer<InputUtil.Key> saveConsumer) {
    ...
    public KeyCodeBuilder setKeyTooltipSupplier(@NotNull Function<InputUtil.Key, Optional<Text[]>> tooltipSupplier) {
