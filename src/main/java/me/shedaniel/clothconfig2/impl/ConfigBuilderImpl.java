...
public class ConfigBuilderImpl implements ConfigBuilder {
    ...
    private Text title = Text.translatable("text.cloth-config.config");
    ...
    private Identifier defaultBackground = Screen.OPTIONS_BACKGROUND_TEXTURE;
    ...
    public Screen build() {
        ...
        screen.setFallbackCategory(fallbackCategory == null ? null : Text.literal(fallbackCategory));
