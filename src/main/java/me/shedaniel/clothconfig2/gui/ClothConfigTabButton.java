...
public class ClothConfigTabButton extends PressableWidget {
    ...
    public void render(DrawContext graphics, int mouseX, int mouseY, float delta) {
        ...
        if (isMouseOver(mouseX, mouseY)) {
            Optional<StringVisitable[]> tooltip = getDescription();
    ...
    public Optional<StringVisitable[]> getDescription() {
