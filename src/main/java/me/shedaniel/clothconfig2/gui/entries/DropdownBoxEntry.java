...
public class DropdownBoxEntry<T> extends TooltipListEntry<T> {
    ...
    public static abstract class DropdownMenuElement<R> extends AbstractParentElement {
        ...
        public abstract void render(DrawContext graphics, int mouseX, int mouseY, Rectangle rectangle, float delta);
        
        public abstract void lateRender(DrawContext graphics, int mouseX, int mouseY, float delta);
    ...
    public static class DefaultDropdownMenuElement<R> extends DropdownMenuElement<R> {
        ...
        public void lateRender(DrawContext graphics, int mouseX, int mouseY, float delta) {
            ...
            if (currentElements.isEmpty()) {
                ...
                graphics.drawTextWithShadow(textRenderer, text.asOrderedText(), (int) (lastRectangle.x + getCellCreator().getCellWidth() / 2f - textRenderer.getWidth(text) / 2f), lastRectangle.y + lastRectangle.height + 3, -1);
            }
    ...
    public static abstract class SelectionCellElement<R> extends AbstractParentElement {
        ...
        public abstract void render(DrawContext graphics, int mouseX, int mouseY, int x, int y, int width, int height, float delta);
        
        public abstract void dontRender(DrawContext graphics, float delta);
    ...
    public static class DefaultSelectionCellElement<R> extends SelectionCellElement<R> {
        ...
        public void render(DrawContext graphics, int mouseX, int mouseY, int x, int y, int width, int height, float delta) {
            ...
            graphics.drawTextWithShadow(MinecraftClient.getInstance().textRenderer, toTextFunction.apply(r).asOrderedText(), x + 6, y + 3, b ? 16777215 : 8947848);
        }
    ...
    public static class DefaultSelectionTopCellElement<R> extends SelectionTopCellElement<R> {
        ...
        public Text getSearchTerm() {
            return Text.literal(textFieldWidget.getText());
        }
        ...
        public Optional<Text> getError() {
            ...
            return Optional.of(Text.literal("Invalid Value!"));
        }
