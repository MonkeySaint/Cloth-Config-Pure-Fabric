        ...
        public Optional<Text> getError() {
            try {
                ...
                if (i > listListEntry.maximum)
                    return Optional.of(Text.translatable("text.cloth-config.error.too_large", listListEntry.maximum));
                else if (i < listListEntry.minimum)
                    return Optional.of(Text.translatable("text.cloth-config.error.too_small", listListEntry.minimum));
            } catch (NumberFormatException ex) {
                return Optional.of(Text.translatable("text.cloth-config.error.not_valid_number_double"));
            }
