...
public abstract class AbstractNumberListEntry<T> extends TextFieldListEntry<T> {
    ...
    @ApiStatus.Internal
    @Deprecated
    protected AbstractNumberListEntry(Text fieldName, T original, Text resetButtonKey, Supplier<T> defaultValue) {
    ...
    @ApiStatus.Internal
    @Deprecated
    protected AbstractNumberListEntry(Text fieldName, T original, Text resetButtonKey, Supplier<T> defaultValue, Supplier<Optional<Text[]>> tooltipSupplier) {
    ...
    @ApiStatus.Internal
    @Deprecated
    protected AbstractNumberListEntry(Text fieldName, T original, Text resetButtonKey, Supplier<T> defaultValue, Supplier<Optional<Text[]>> tooltipSupplier, boolean requiresRestart) {
